...
class Team extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('team/login',$data);
    }
    ...
    public function register() {
        ...
        $data = array();
        $this->load->view('team/register',$data);
    }
    ...
    public function forgot(){
        ...
        $data = array();
        $this->load->view('team/forgot',$data);
    }
    ...
    public function resetpassword(){
        ...
        $this->load->view('team/resetpassword',$data);
    }
    ...
    public function home() {
        ...
        $json_encode = post_curl(API_CALL_PATH.'team/getAllHomePageData', $this->input->post(), $this->curl);
    ...
    public function switch_profile() {
        $data = array();
        $this->load->view('team/switch_profile',$data);
    }
