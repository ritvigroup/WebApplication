                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Vehicle Name" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Registration Number: </label>
                            <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Registration Number" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="email" name="email" placeholder="Driver Name" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
