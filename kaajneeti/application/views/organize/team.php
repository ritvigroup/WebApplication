                            ...
                            <div class="portlet-header">
                              <div class="portlet-header">
                                <ol class="breadcrumb">
                                    ...
                                    <li><a class="text-capitalize" href="javascript:void(0);">Organize</a> </li>
                                    <li class="active"><strong><a class="text-capitalize" href="<?=base_url(); ?>plan/plan">Team</a> </strong> </li>
                                </ol>
                              </div>
                                <div class="row">
                                    <div class="col-md-6">
