...
<head><title>Team Login</title>
    ...
    <!-- adminbag main css -->
    <link href="<?=base_url();?>assets/css/main_team.css" rel="stylesheet">
        ...
        <div class="widgets-container">
            ...
            <p>Login in. To see it in action.</p>
            	<form method="post" onsubmit="return false;">
	                ...
	                <!-- <a href="<?=base_url();?>team/forgot"><small>Forgot password?</small></a> -->
                </form>
...
<script>
    document.querySelector('.signin_up_button').onclick = function () {
        ...
        if (signin_username.length > 0 && signin_password.length > 0) {
            ...
            $.post("<?php echo base_url(); ?>team/login", {username: signin_username, password: signin_password},
