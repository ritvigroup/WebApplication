<!DOCTYPE html>
<html lang="en">
<head><title>My Non Active Group</title>
    <meta charset="utf-8">
                        ...
                        <div class="portlet box ">
                            <div class="portlet-header">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active"><strong><a class="text-capitalize" href="<?=base_url(); ?>report/nonactivegroup">My Non Active Group</a> </strong> </li>
                                </ol>
                            </div>
                            <?php
                            // echo '<pre>';
