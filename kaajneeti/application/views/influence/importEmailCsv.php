<form name="plan_form" method="post" action="<?php echo base_url(); ?>influence/email" onSubmit="return false;">
    <div class="modal-header">
        ...
        <h4 id="modal-stackable-label" class="modal-title">Import Email CSV</h4>
    </div>
    <div class="modal-body">
        <div class="panel panel-white">
            <div class="panel-heading">Import Email CSV</div>
            <div class="panel-body">
                
                <div class="form-group">
                    <label>CSV File: </label>
                    <input type="file" name="csv_file" class="form-control fileUploadForm" />
                </div>
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-success btn_email_submit" onClick="return uploadEmailCsv();">Send</button>
