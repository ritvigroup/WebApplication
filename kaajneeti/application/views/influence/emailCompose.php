<form name="plan_form" method="post" action="<?php echo base_url(); ?>influence/influence" onSubmit="return false;">
    <div class="modal-header">
        ...
        <h4 id="modal-stackable-label" class="modal-title">Compose Email</h4>
    </div>
        ...
        <div class="panel panel-white">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <label>To: </label>
                    <input type="text" class="form-control" id="email_text" name="email_text" placeholder="To" required>
                </div>
