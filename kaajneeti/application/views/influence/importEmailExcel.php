<form name="plan_form" method="post" action="<?php echo base_url(); ?>influence/email" onSubmit="return false;">
    <div class="modal-header">
        ...
        <h4 id="modal-stackable-label" class="modal-title">Import Email Excel</h4>
    </div>
    <div class="modal-body">
        <div class="panel panel-white">
            <div class="panel-heading">Import Email Excel</div>
            <div class="panel-body">
                
                <div class="form-group">
                    <label>Excel File: </label>
                    <input type="file" name="xls_file" class="form-control fileUploadForm" />
                </div>
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-success btn_email_submit" onClick="return uploadEmailXls();">Send</button>
...
<script>
    function uploadEmailXls() {
        ...
        if (subject_text.length > 0) {
            ...
            jQuery.each($('input[name^="xls_file"]')[0].files, function(i, file) {
                form_data.append('xls_file', file);
            });

            form_data.append('subject_text', subject_text);
            form_data.append('message_text', message_text);
            form_data.append('email_xls', 'Y');
