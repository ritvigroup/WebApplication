...
<head><title>Administrator Login</title>
    ...
    <!-- adminbag main green css -->
    <link href="<?=base_url();?>assets/css/main-green.css" rel="stylesheet">
    <!-- aqua green theme css -->
            ...
            <p>Login in. To see it in action.</p>
            	<form method="post" onsubmit="return false;">
	                <div class="form-group">
	                    <input type="text" required="" name="username" placeholder="Username" class="form-control signin-username" autocomplete="off">
	                </div>
	                <div class="form-group">
	                    <input type="password" required="" name="password" placeholder="Password" class="form-control signin-password" autocomplete="off">
	                </div>
...
<script>
    document.querySelector('.signin_up_button').onclick = function () {
        ...
        if (signin_username.length > 0 && signin_password.length > 0) {
            ...
            $.post("<?php echo base_url(); ?>admin/login", {username: signin_username, password: signin_password},
