                        ...
                        <div class="portlet box ">
                            <div class="portlet-header">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active"><strong><a class="text-capitalize" href="<?=base_url(); ?>connect/outgoing">Outgoing</a> </strong> </li>
                                </ol>
                            </div>
                                                    ...
                                                    <div class="contact-box">
                                                        <div class="col-sm-12">
                                                            ...
                                                            <div class="connection-features" id="dropdown_and_button_<?php echo $users->UserProfileId; ?>">
                                                                <div>
                                                                    <button class="btn btn-default" type="button" onClick="return cancelRequest(<?php echo $users->UserProfileId; ?>);">Undo</button>
                                                                </div>
                                                            </div>    
                                                        </div>
                                                        <div class="clearfix"></div>
