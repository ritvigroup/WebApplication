                        ...
                        <div class="portlet box ">
                            <div class="portlet-header">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active"><strong><a class="text-capitalize" href="<?=base_url(); ?>connect/group">Group</a> </strong> </li>
                                </ol>
                            </div>
                                ...
                                <div class="mbm">
                                    ...
                                    <div class="row margin-left-right-0 connect-menu-contents">
                                        ...
                                        <div class="connect_list">
                                            <?php 
                                            foreach($Connections->result AS $group) {
                                                $FriendGroupName = $group->FriendGroupName;
                                                
                                                $ProfileName = $group->GroupProfile->FirstName.' '.$group->GroupProfile->LastName;

                                                $group_profile_pic = ($group->GroupProfile->ProfilePhotoPath != '') ? $group->GroupProfile->ProfilePhotoPath : base_url().'assets/images/teem/a1.jpg';

                                                if($group->GroupProfile->ProfilePhotoPath != '') {
                                                    $profile_pic = ($group->GroupProfile->ProfilePhotoPath != '') ? $group->GroupProfile->ProfilePhotoPath : base_url().'assets/images/default-user.png';
                                                } else {
                                                    $profile_pic = ($group->GroupProfile->ProfilePhotoPath != '') ? $group->GroupProfile->ProfilePhotoPath : base_url().'assets/images/default-user.png';
                                                } 
                                                ...
                                                /*
                                                ?>
                                                <div class="grid-list-view grid col-md-4 col-sm-6" data-name="<?php echo $Name; ?>" id="connection_id_<?php echo $group->UserProfileId; ?>">
                                                ...
                                                */ ?>
                                                ...
                                                <div class="grid-list-view grid col-md-4 col-sm-6" id="group_id_<?php echo $group->FriendGroupId; ?>">
                                                    <div class="contact-box">
                                                        <div class="col-sm-12">
                                                            <a href="<?=base_url();?>profile/profile"">
                                                                <img src="<?php echo $group_profile_pic; ?>" class="img-responsive" alt="image">
                                                            </a>
                                                            
                                                            <h3><strong><?php echo $FriendGroupName; ?></strong></h3>
                                                    ...
                                                    <div class="new_loader_div" id="connection_loader_id_<?php echo $group->FriendGroupId; ?>"><img src="<?=base_url();?>assets/images/new-loader.gif"></div>
                                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="portlet box ">
                            <div class="portlet-header">
                                <ol class="breadcrumb">
                                    <li> <a class="text-capitalize" href="<?=base_url();?>leader/dashboard">Kaajneeti</a> </li>
                                    <li> <a class="text-capitalize" href="<?=base_url(); ?>connect/myconnections">Connect</a> </li>
                                                        ...
                                                        <div class="col-md-6 ">
                                                            <div class="pull-right"> 
                                                                <!-- <div class="btn-group" role="group" > -->
                                                                    <!-- <div class="btn-group" role="group"> -->
                                                                         <button type="button" class="btn aqua btn-outline btn-sm text-capitalize"><a href="<?=base_url();?>connect/searchconnection"><i class="fa fa-plus"></i> Find Connections</a></button>
