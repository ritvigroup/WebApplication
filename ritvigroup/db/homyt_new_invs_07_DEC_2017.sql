...
insert  into `investors_contracts`(`id`,`investor_id`,`contract_image`,`contract_image_name`,`uploaded_on`) values (11,11,'1509108344_20171027181544_INVS_CONTRACT_368014006.jpg','215659.jpg','2017-10-27 18:15:44');
insert  into `investors_contracts`(`id`,`investor_id`,`contract_image`,`contract_image_name`,`uploaded_on`) values (12,12,'1509119477_20171027212117_INVS_CONTRACT_421779119.','','2017-10-27 21:21:17');
...
insert  into `investors_contracts`(`id`,`investor_id`,`contract_image`,`contract_image_name`,`uploaded_on`) values (19,19,'1509277452_20171029171412_INVS_CONTRACT_57187532.','','2017-10-29 17:14:12');
insert  into `investors_contracts`(`id`,`investor_id`,`contract_image`,`contract_image_name`,`uploaded_on`) values (20,20,'1509431873_20171031120753_INVS_CONTRACT_1210630434.jpg','scan0023.jpg','2017-10-31 12:07:53');
...
insert  into `investors_ids`(`id`,`investor_id`,`id_type`,`id_number`,`status`,`created_on`) values (11,11,'Personal Id','851690784',1,'2017-10-27 18:15:44');
insert  into `investors_ids`(`id`,`investor_id`,`id_type`,`id_number`,`status`,`created_on`) values (12,12,'Personal Id','312447808',1,'2017-10-27 21:21:17');
...
insert  into `investors_ids`(`id`,`investor_id`,`id_type`,`id_number`,`status`,`created_on`) values (19,19,'Personal Id','1055795551',1,'2017-10-29 17:14:12');
insert  into `investors_ids`(`id`,`investor_id`,`id_type`,`id_number`,`status`,`created_on`) values (20,20,'Passport','06675257',1,'2017-10-31 12:07:53');
...
insert  into `investors_ids_image`(`id`,`investors_ids_id`,`image_path`,`image_name`,`uploaded_on`) values (11,11,'1509108344_20171027181544_INVS_ID_1172316104.jpg','Ù¢Ù Ù¡Ù§Ù¡Ù Ù¢Ù§_Ù¡Ù¥Ù¢Ù¨Ù¡Ù¢.jpg','2017-10-27 18:15:44');
insert  into `investors_ids_image`(`id`,`investors_ids_id`,`image_path`,`image_name`,`uploaded_on`) values (12,12,'1509119477_20171027212117_INVS_ID_1433663149.jpg','11 001.jpg','2017-10-27 21:21:17');
...
insert  into `investors_ids_image`(`id`,`investors_ids_id`,`image_path`,`image_name`,`uploaded_on`) values (20,20,'1509431873_20171031120753_INVS_ID_1135274710.jpg','scan0128.jpg','2017-10-31 12:07:53');
...
insert  into `investors_shares`(`id`,`investor_id`,`share_number`,`share_amount`,`share_date`) values (19,11,'1','1000 $','1970-01-01');
insert  into `investors_shares`(`id`,`investor_id`,`share_number`,`share_amount`,`share_date`) values (20,12,'1','725 Ø¯ÙˆÙ„Ø§Ø±','2014-08-18');
insert  into `investors_shares`(`id`,`investor_id`,`share_number`,`share_amount`,`share_date`) values (21,12,'1','700 Ø¯ÙˆÙ„Ø§Ø±','2014-09-14');
...
insert  into `investors_shares`(`id`,`investor_id`,`share_number`,`share_amount`,`share_date`) values (29,19,'11,000 usd','11,000 usd','2017-03-01');
insert  into `investors_shares`(`id`,`investor_id`,`share_number`,`share_amount`,`share_date`) values (30,20,'18','10500 Ø¯ÙˆÙ„Ø§Ø±','2017-10-26');
...
insert  into `users`(`id`,`name`,`email`,`username`,`password`,`phone`,`status`,`gender`,`profileimg`,`company`,`created_on`,`updated_on`,`created_by`) values (1,'Rajesh Vishwakarma','rajesh1may@gmail.com','rajesh1may@gmail.com','e10adc3949ba59abbe56e057f20f883e','234234324234',1,'','/profileimg.png','Ø³Ù„Ø·Ù†Ø© Ø¹ÙÙ…Ø§Ù†','2017-10-12 06:30:32','0000-00-00 00:00:00',0);
insert  into `users`(`id`,`name`,`email`,`username`,`password`,`phone`,`status`,`gender`,`profileimg`,`company`,`created_on`,`updated_on`,`created_by`) values (2,'Zeedats','zeedats95@gmail.com','zeedats','7c888f1631365c740ab3c38e98cfa37f','234234324234',1,'','/uploads/profile/1509098388_20171027152948_830046448.png','','2017-11-09 11:19:32','0000-00-00 00:00:00',0);
