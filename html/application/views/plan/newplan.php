                        ...
                        <div class="portlet box">
                            <div class="portlet-header">
                                ...
                                <div class="actions">
                                    ...
                                    <a data-target="#modal-stackable" data-toggle="modal" href="javascript:void(0);" onClick="return nextScreen(0);" title="Let's begin with your Goal" class="btn btn-info btn-xs"><i class="fa fa-plus"></i>&nbsp;Create Plan</a>&nbsp;
